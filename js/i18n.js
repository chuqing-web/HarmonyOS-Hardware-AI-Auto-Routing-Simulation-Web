...
(function (global) {
  const dict = {
    en: {
      ...
      'hero.sub': 'Schematic editing, mixed-signal simulation, and PCB 2D/3D preview on HarmonyOS — with an engineered multi-agent loop from clarify to QA.',
    ...
    zh: {
      ...
      'hero.sub': '原理图编辑、混合信号仿真与 PCB 2D/3D 预览，原生运行于鸿蒙——工程化多 Agent 闭环从澄清到 QA。',
