...
(function (global) {
  const dict = {
    en: {
      ...
      'hero.sub': 'Proteus-class editing, mixed-signal simulation, and PCB 2D/3D preview on HarmonyOS — with an engineered multi-agent loop from clarify to QA.',
      'hero.ctaPrimary': 'Explore capabilities',
      'hero.ctaSecondary': 'PCB 2D / 3D',
      ...
      'pipe.title': 'From clarify to hard gates',
      'pipe.sub': 'Six engineered stages — each hands off structured artifacts, never free-form “text as circuit.”',
      'pipe.flow': 'Clarify → Select → Layout → Net → WAR → QA',
      'pipe.s1': 'Clarify',
    ...
    zh: {
      ...
      'hero.sub': '对标 Proteus 的编辑、混合信号仿真与 PCB 2D/3D 预览，原生运行于鸿蒙——工程化多 Agent 闭环从澄清到 QA。',
      ...
      'pipe.eyebrow': 'AI 闭环',
      'pipe.title': '从澄清到硬门禁',
      'pipe.sub': '六步工程化交接——每步只传递结构化产物，杜绝「一段文字当电路」。',
      'pipe.flow': '澄清 → 选型 → 布局 → 建网 → WAR → QA',
      'pipe.s1': '澄清',
      'pipe.s1d': '只追问拓扑歧义',
      'pipe.s2': '选型',
      'pipe.s2d': '库内 BOM，抑幻觉',
